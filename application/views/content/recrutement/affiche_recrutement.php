                        ...
                        <form id="demo-bv-bsc-tabs" class="form-horizontal" action="<?php echo site_url('recrutement/reponse_demande'); ?>" method="post">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="demo-bsc-tab-3">
                                    ...
                                    <div class="form-group has-success pad-ver">
                                        <label for="demo-vs-scsinput" class="col-lg-2 control-label">Etat</label>
                                        <div class="col-md-5 pad-no">
                                            <input id="demo-vs-scsinput" class="form-control" type="text" value="<?php echo $msg ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="abandon">
                                        ...
                                        <div class="col-lg-9 pad-no">
                                            <textarea placeholder="Vous devez indiquer un motif pour refuser la demande de recrutement" rows="4" name="motif" class="form-control"><?php echo $motif; ?></textarea>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                    <!--<div class="form-group" >
