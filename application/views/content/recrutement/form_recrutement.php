  <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <li><a href="<?php echo site_url('recrutement') ?>">Recrutement</a></li>
                    <li class="active">Recruter</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                        ...
                        <div class="eq-height clearfix">
                            <div class="col-md-4 eq-box-md text-center box-vmiddle-wrap bord-hor">
                                ...
                                <div class="box-vmiddle pad-all">
                                    ...
                                    <p class="pad-btn text-sm">Cette demande va être envoyée à l'administration pour validation avant d'être traitée par le chargé de recrutement</p>
                                    <br>
                                    <a class="btn btn-purple" href="<?php echo site_url('recrutement') ?>">Voir mes demandes</a>
                                </div>
                                <!--===================================================-->
                                    ...
                                    <form class="form-horizontal" method="POST" action="<?php echo site_url('recrutement/demander') ?>">
                                        <div class="panel-body">
                                            <div class="tab-content">
                                                <input type="hidden" class="form-control" name="statut" value="ajout">
                                                <!--First tab-->
                                                <div id="demo-main-tab1" class="tab-pane">
                                                    <div class="form-group">
                                                        <label class="col-lg-3 control-label">Nom demandeur</label>
                                                        <div class="col-lg-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-lg-3 control-label">Fonction demandeur</label>
                                                        <div class="col-lg-8">
                                                ...
                                                <div id="demo-main-tab2" class="tab-pane fade">
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" placeholder="le poste à pourvoir" name="poste" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-lg-2 control-label">Campagne</label>
                                                        <div class="col-lg-8">
                                                            <input type="text" placeholder="Campagne ou département" name="campagne" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8 pad-no">
                                                            <div class="clearfix">
                                                                <div class="col-lg-3">
                                                                    <input type="integer" placeholder="nbre à pourvoir" name="nombre" class="form-control" >
                                                                </div>
                                                                <div class="col-lg-3 text-lg-right"><label class="control-label">Type de contrat</label></div>
                                                                <div class="col-lg-6"><input type="text" placeholder="CDD ou CDI" name="contrat" class="form-control"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                             <input type="text" placeholder="" name="horaire" class="form-control" >
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="demo-main-tab3" class="tab-pane">
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-lg-9 pad-no">
                                                              <textarea placeholder="les qualifications requises ..." rows="4" name="qualification" class="form-control" ></textarea>
                                                        </div>
                                                    </div>
                                                   <div class="form-group">
                                                        <label class="col-lg-2 control-label">Compétences</label>
                                                        <div class="col-lg-9 pad-no">
                                                              <textarea placeholder="compétences nécessaires ..." rows="4" name="competences" class="form-control" ></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-lg-2 control-label">Atouts</label>
                                                        <div class="col-lg-9 pad-no">
                                                            <textarea placeholder="..." rows="4" name="atout" class="form-control" ></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="pull-right pad-rgt mar-btm">
                                            ...
                                            <button type="submit" class="finish btn btn-success" disabled>Soumettre</button>
                                        </div>
