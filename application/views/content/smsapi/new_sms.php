                                ...
                                <form id="" action="<?php echo site_url("$action"); ?>" class="form-horizontal" method="POST">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <input type="text" name='tel' placeholder="Numéro téléphone" class="form-control" value="" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <input type="text" placeholder="nom du client" id="demo-hor-nomdest" class="form-control" name='nomdest' value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label" for="demo-hor-IBAN">Code IBAN destinataire</label>
                                            <div class="col-lg-7">
                                                <input type="text" placeholder="son code IBAN vérifié" id="demo-hor-inputIBAN" class="form-control" name='IBAN' value="" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                                <label class="col-lg-3 control-label">Email</label>
                                                <div class="col-lg-7">
                                                    <input type="email" class="form-control" name="emaildest" placeholder="email" value="">
                                                </div>
                                        </div>
