                                ...
                                <form id="" action="<?php echo site_url("$action"); ?>" class="form-horizontal" method="POST">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <input type="text" name='emetteur' placeholder="Msg en provenance de" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <input type="text" name='nom_modele' placeholder="nommer ce modèle" class="form-control" value="" required>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="panel">
                                    <div class="panel-body">
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                <div class="col-lg-12">
                                                <textarea name="modele_contenu" placeholder="Tapez ici le message à enregistrer" rows="7" class="form-control" required></textarea>     
                                            </div>
                                       ...
                                       <br/> 
                                       <div class="row">
                                            <div class="col-md-7"><input class="btn btn-md btn-mint" type="submit" value="Enregistrer">
                                            </div>
                                        </div>
