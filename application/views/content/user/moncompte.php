                                ...
                                <form id="1" action="<?php echo site_url("$action"); ?>" class="form-horizontal" method="POST">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="email" class="form-control" name="email" placeholder="email" value="<?php echo $row['USER_MAIL']; ?>"  <?php if ($modif=='1') { echo 'readonly'; } ?>>
                                                </div>
                                        </div>        
                                        <div class="form-group">
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="password" class="form-control" name="password" placeholder="mot de passe" <?php if ($modif!='1') { echo 'required'; } ?>>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">Confirmation mot de passe</label>
                                                <div class="col-lg-7">
                                                    <input type="password" class="form-control" name="confirmPassword" placeholder="Retaper le mot de passe" <?php if ($modif!='1') { echo 'required'; } ?>>
                                                </div>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-7">
                                                    ...
                                                    <div class="checkbox">
                                                        <input id="demo-checkbox-2" class="magic-checkbox" type="checkbox" name="accesstat" value="1"  <?php if ($rowdroit['DROIT_STATISTIQUE']=='1') { echo 'checked'; } ?>>
                                                        <label for="demo-checkbox-2">Statistiques</label>
                                                    </div>
                                                    
                    
                                                    <div class="checkbox">
                                                        <input id="demo-checkbox-3" class="magic-checkbox" type="checkbox" name="accesenr" value="1" <?php if ($rowdroit['DROIT_ENREGISTREMENT']=='1') { echo 'checked'; } ?>>
                                                        <label for="demo-checkbox-3">Enregistrements</label>
                                                    </div>
                                                </div>    
